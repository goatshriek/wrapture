  ...
  module Build
    ...
    class PyprojectBuild
      ...
      def install_commands(python: 'python3',
                           target: "dist/#{@source_set.name}-*.whl")
      ...
      def pyproject
        ...
        libraries = @source_set.module_links.map do |lib|
          "\"#{lib}\""
        end.join(', ')
        ...
        file.puts <<~PYPROJECTTEXT
          ...
          version = "1.0" # TODO: create a namespace version number
          description= "generated by wrapture" # TODO: pass the description into the build

          [tool.setuptools]
          ext-modules = [
            {name="#{@source_set.name}", language="c", sources=[#{sources}], libraries=[#{libraries}]}
          ]
